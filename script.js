...
console.log(secondHigh[1]);

const arr = ['java','python', 'c++','javaScript','Csharp'];
...
let textBox = document.getElementById('search');
 ...
 fetch('https://jsonplaceholder.typicode.com/users').then(res => res.json()).then(users => showUser(users));
